...
class CriminalJusticeCurriculumTests(unittest.TestCase):
    ...
    def test_math_quant_selector_is_restricted_to_mat_150(self):
        by_code = {row["course_code"]: row for row in self.rows}
        mat_150 = by_code["MAT 150"]
        self.assertEqual("Required Common Core", mat_150["group_name"])
        self.assertEqual("4", mat_150["credits"])
        self.assertEqual("CRJ_AA_MATH_QUANT", mat_150["choice_group_code"])
        ...
        self.assertEqual("MAT 150", adjustment["include_course_codes"])
