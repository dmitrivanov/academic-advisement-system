"""Build the two Phase 5 PDF deliverables from their Markdown sources."""
...
DOCUMENTS = (
    (ROOT / "docs/CUNY_BEYOND_PHASE_5_PROGRESS.md", ROOT / "output/pdf/CUNY_Beyond_Phase_5_Progress.pdf", "CUNY Beyond | Phase 5 Progress"),
    (ROOT / "docs/CUNY_BEYOND_PHASE_5_TESTER_GUIDE.md", ROOT / "output/pdf/CUNY_Beyond_Phase_5_Tester_Guide.pdf", "CUNY Beyond | Phase 5 Tester Guide"),
)
