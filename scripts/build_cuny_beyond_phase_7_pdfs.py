"""Build the two Phase 7 PDF deliverables from their Markdown sources."""
...
DOCUMENTS = (
    (ROOT / "docs/CUNY_BEYOND_PHASE_7_PROGRESS.md", ROOT / "output/pdf/CUNY_Beyond_Phase_7_Progress.pdf", "CUNY Beyond | Phase 7 Progress"),
    (ROOT / "docs/CUNY_BEYOND_PHASE_7_TESTER_GUIDE.md", ROOT / "output/pdf/CUNY_Beyond_Phase_7_Tester_Guide.pdf", "CUNY Beyond | Phase 7 Tester Guide"),
)
